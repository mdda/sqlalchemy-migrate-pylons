...
``python sqlalchemy-migrate-pylons.py development.ini`` to check what needs to be changed.
``python sqlalchemy-migrate-pylons.py --commit development.ini`` to implement the changes and report back.
